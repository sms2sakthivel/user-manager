...
// // RegisterRoutes registers the endpoints for the User Service.
// //
// //	@Summary		User Service Endpoints
// //	@Description	Register routes for user operations.
// //	@Tags			User
...
// 	// Swagger endpoint
// 	// This endpoint does not require Swagger annotations as it's a UI handler.
